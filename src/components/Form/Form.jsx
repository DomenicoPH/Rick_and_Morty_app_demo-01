  ...
  return (
    <div className={style.container}>
      ...
      <Modal
        ...
        title={<><IoInformationCircleOutline size={40} /> This is a Demo App</>}
      ...
      >
        <div className={style.modal_div_p}>
        ...
        <p className={style.modal_credentials}>
